...
import { UserCheck, ArrowLeft, LogIn } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // Store employee data in localStorage (in production, use proper auth)
        ...
        <div className="w-full max-w-md">
          <Card className="border-2 shadow-xl">
            <CardHeader className="space-y-4 text-center">
              ...
              <div>
                <CardTitle className="text-2xl">Karyawan Login</CardTitle>
                <CardDescription className="mt-2">
                  Masuk ke panel karyawan untuk absensi dan riwayat
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="flex flex-col gap-2 text-sm text-slate-500">
              ...
              <p className="font-mono">Email: employee@example.com</p>
              <p className="font-mono">Password: employee123</p>
            </CardFooter>
          </Card>
        </div>
      </main>
